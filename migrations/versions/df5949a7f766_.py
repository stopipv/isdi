...
Revision ID: df5949a7f766
Revises: 
Create Date: 2019-06-27 17:50:24.741155
...
def upgrade():
    ...
    op.add_column('clients_notes', sa.Column('clientid', sa.String(length=100), server_default='', nullable=False))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('clients_notes', 'clientid')
