...
def info(d, appid):
    ...
    res['data_usage'] = get_data_usage(d, process_uid)
    res['battery (mAh)'] = get_battery_stat(d, uidu)
    return res
...
if __name__ == "__main__":
    ...
    print(json.dumps(info(d, 'com.life360.android.safetymapd'), indent=2))
