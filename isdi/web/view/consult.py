...
def client_forms():
    ...
    if request.method == 'POST':
        try:
            if form.validate():
                ...
                sa.session.commit()
                return render_template('main.html', task="form", formdone='yes', title=isdi.config.TITLE)
    ...
    return render_template('main.html', task="form", form=form, title=isdi.config.TITLE, clientid=session['clientid'])
...
def edit_forms():
    if request.method == 'POST':
        ...
        if clientnote: # if requesting a form to edit
            ...
            return render_template('main.html', task="form",form=form, title=isdi.config.TITLE, clientid=form_obj.clientid)
    ...
    return render_template('main.html', clients=clients, task="formedit", title=isdi.config.TITLE)
